...
window.addEventListener('load', function() {
    ...
    if (query) {
        ...
        var filteredData = productData.filter(function(element) {
            return (element.brand && element.brand.toLowerCase().includes(query)) ||
                   (element.category && element.category.toLowerCase().includes(query)) ||
                   (element.para && element.para.toLowerCase().includes(query));
        });
